    ...
    <script>
        ...
        const loadEmployees = async function () {
            ...
            try {
                ...
                // Предполагаем, что сервер возвращает JSON-массив объектов
                const employees = await response.json();
                requestResult.style.display = "none"; // Скрываем блок статуса при успехе

                employeesTableBody.innerHTML = ""; // Убираем статические строки
                if (workersCount) {
