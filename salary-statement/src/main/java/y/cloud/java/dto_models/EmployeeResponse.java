...
public class EmployeeResponse {
    ...
    public EmployeeResponse(Employee employee) {
        ...
        this.middle_name = employee.getMiddleName();
        this.birth_date = employee.getBirthDate();
        this.work_experience = employee.getWorkExperience();
        this.post_id = employee.getPostId();
